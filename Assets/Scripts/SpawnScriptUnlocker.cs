...
public class SpawnScriptUnlocker : MonoBehaviour
{
    ...
    public float char1PointsToUnlock = 6f;
    public float char2PointsToUnlock = 8f;
    public float char3PointsToUnlock = 9f;
    public float char4PointsToUnlock = 11f;
    public float char5PointsToUnlock = 12f;
    public float char6PointsToUnlock = 13f;
    public float char7PointsToUnlock = 11f;
    public float char8PointsToUnlock = 14f;
    public float char9PointsToUnlock = 16f;
    public float char10PointsToUnlock = 7f;
    public float char11PointsToUnlock = 11f;
    public float char12PointsToUnlock = 14f;
    public float char13PointsToUnlock = 12f;
    public float char14PointsToUnlock = 9f;
    public float char15PointsToUnlock = 10f;
    public float char16PointsToUnlock = 15f;
    public float char17PointsToUnlock = 13f;
    public float char18PointsToUnlock = 10f;
    public float char19PointsToUnlock = 11f;
    public float char20PointsToUnlock = 12f;
    public float char21PointsToUnlock = 15f;
    public float char22PointsToUnlock = 8f;
    public float char23PointsToUnlock = 11f;
    public float char24PointsToUnlock = 9f;
    public float char25PointsToUnlock = 10f;
    public float char26PointsToUnlock = 14f;
    public float char27PointsToUnlock = 15f;
    public float char28PointsToUnlock = 13f;
    public float char29PointsToUnlock = 14f;
    public float char30PointsToUnlock = 16f;
