...
public class GenerateColliders : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        topCollider.GetComponent<BoxCollider>().material = (PhysicMaterial)Resources.Load("PhysicMaterials/Bouncy");
        bottomCollider.GetComponent<BoxCollider>().material = (PhysicMaterial)Resources.Load("PhysicMaterials/Bouncy");
        rightCollider.GetComponent<BoxCollider>().material = (PhysicMaterial)Resources.Load("PhysicMaterials/Bouncy");
        leftCollider.GetComponent<BoxCollider>().material = (PhysicMaterial)Resources.Load("PhysicMaterials/Bouncy");
