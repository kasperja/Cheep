...
public class TextOutline : MonoBehaviour {
	...
	void Start() {
		...
		for (int i = 0; i < 8; i++) {
			...
			outline.transform.localRotation = textMesh.transform.localRotation;
			...
			//otherMeshRenderer.material.color = new Color(0.167f,0.472f,0.5f, textMesh.GetComponent<MeshRenderer>().material.co);
		}
	}
